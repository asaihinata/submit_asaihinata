...
class Scatter(twoDElement):
 def __init__(self,master,kw):
  ...
  self.plot(self.x,self.y,xlabel=self.xlabel,ylabel=self.ylabel,marker=self.marker,linewidth=self.linewidth,alpha=self.alpha,label=self.label,s=self.s)
 def plot(self,x,y,xlabel=None,ylabel=None,marker=None,linewidth=2,alpha=1,label=None,s=10):
  self.clear()
 ...
 def update(self,x=None,y=None,**kw):
  ...
  self.plot(self.x,self.y,xlabel=self.xlabel,ylabel=self.ylabel,marker=self.marker,linewidth=self.linewidth,alpha=self.alpha,label=self.label)
  self._redraw()
